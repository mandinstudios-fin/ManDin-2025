    ...
    return (
        <AuroraBackground>
            <div className="flex items-center justify-center h-screen text-white">
                ...
                <div className="z-[100] fixed top-10 lg:px-[4rem] px-[1rem] w-full mix-blend-difference lg:mix-blend-normal">
                    <div className='flex items-center justify-between'>
                        ...
                        <FadeInOnScroll>
                            <div onClick={toggleMenu} className="flex items-center bg-white/10 px-[1rem] lg:px-[2rem] py-[0.5rem] lg:py-[0.7rem] gap-[0.5rem] backdrop-blur-[8px] cursor-pointer" >
            ...
            <div className={`full-page-menu ${isMenuOpen ? 'open' : ''}`}>
                ...
                <div className='absolute h-[50rem] w-[50rem] bg-orange rounded-full opacity-[12%] -right-[30rem] blur-[80px]' />
            </div>
        </AuroraBackground>
    )
}
