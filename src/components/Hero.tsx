...
const Hero = () => {
    ...
    return (
        <header className='w-full ' style={{ height: `${height}px` }}>
            ...
            <div className="z-[10] fixed top-10 lg:px-[4rem] px-[1rem] w-full">
                <div className='flex items-center justify-between'>
                    <div>
                        <img src={logo} className='w-[10rem] lg:w-[19rem] drop-shadow-2xl' />
                    </div>
                    <div className="flex items-center bg-white/10 px-[1rem] lg:px-[2rem] py-[0.5rem] lg:py-[0.7rem] gap-[0.5rem] backdrop-blur-[8px] cursor-pointer" onClick={toggleMenu}>
                        ...
                        <Menu className='text-black lg:text-white' />
                    </div>
                </div>
            </div>
            ...
            <div className='z-2 max-w-[1280px] mx-auto p-[2rem] h-full '>
                <div>
                    <h2 className='text-[1.99rem] lg:text-[4rem] leading-[1.1] font-["Denton-Bold"] font-extrabold text-center mt-[13rem]'>Where Expertise Meets Artistry</h2>
                    <h2 className='text-[1.99rem] lg:text-[4rem] leading-[1.1] font-["Denton-Bold"] font-extrabold text-center'>You're Witnessing Brillliance Unfold.</h2>
                    <p className='text-[1.2rem] lg:text-[2.5rem] mt-[0.5rem] text-center font-["Gilroy-Regular"]'>You are witnessing a Master at Work</p>
                    ...
                    <div className="menu-items">
                        {navItems.map((item, index) => (
                            <div key={item.id} className="menu-item-wrapper" style={{ transitionDelay: `${index * 0.1}s` }}>
                                <a href={`#${item.path}`} className="menu-item p-[0.5rem] lg:p-[1rem]" onClick={() => setIsMenuOpen(false)}>
