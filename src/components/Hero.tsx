    ...
    return (
        <header className='w-full ' style={{ height: `${height}px` }}>
            ...
            <div className='z-2 max-w-[1280px] mx-auto p-[2rem] h-full '>
                <div className='mt-[11rem] lg:mt-[13rem]'>
                    <h2 className='block text-center font-["Poppins-ExtraLight"] lg:hidden mb-[0.5rem]'>ManDin Studios</h2>
            ...
            {/* {visible && (
                <div
                    className={`fixed inset-0 bg-black transition-opacity duration-1000 ease-in-out z-[9999] flex justify-center items-center ${fadeOut ? 'opacity-0 pointer-events-none' : 'opacity-100'
                        }`}
                >
                    <svg className='svg' xmlns="http://www.w3.org/2000/svg">
                        <text
                            ...
                            className="loadertext text-[3rem] md:text-[3.5rem] lg:text-[5rem]"
                            text-anchor="middle"
                        ...
                        <text
                            ...
                            y="50%"
                            font-family="'Open Sans', sans-serif"
                            className="fill text-[3rem] md:text-[3.5rem] lg:text-[5rem]"
                            text-anchor="middle"
                            alignment-baseline="middle"
                        >
                            ManDin Studios
