...
const Footer = () => {
  return (
    <footer id='footer' className="footer">
      <div className="footer-content font-['Gilroy-Regular']">
        <div className="footer-section">
          <h3>Contact Us</h3>
          <p><a href='https://maps.app.goo.gl/VA3xfCh99fSJzchM8' target='_blank'>Address: Jubliee Hills, Hyderabad.</a></p>
          <p>Email: <a href='mailto:info@mandinstudios.com' target='_blank'>info@mandinstudios.com</a></p>
          <p>Phone: +91 91159 62222</p>
        </div>
        <div className="footer-section">
          <h3>Follow Us</h3>
          <div className="card">
            ...
            <a className="socialContainer containerFour" href="https://wa.me/919115962222" target='_blank'>
        ...
        <div className="hidden footer-section lg:block">
          <h3>Quick Links</h3>
          {navItems.map((item) => <a className='cursor-pointer section-link' onClick={() => handleScroll(item.path)}>{item.title}</a>)}
