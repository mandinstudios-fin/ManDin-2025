    ...
    return (
        <div ref={introRef} id='what-we-do' className='max-w-[1300px] mx-auto relative'>
            ...
            <div className='mt-[4rem] lg:mt-[6rem] relative z-10'>
                {/* Mobile: Show only first 3 cards, Desktop: Show all 5 */}
                <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-[1.5rem] md:gap-[2rem] lg:gap-[4rem]'>
                    {FEATURES.slice(0, isMobile ? 3 : 5).map((feature, index) => (
                        <div
                            key={index}
                    ...
                    <div className='block lg:hidden'>
                        <div className='flex gap-[1rem] overflow-x-auto scrollbar-hide pb-[1rem] snap-x snap-mandatory'>
                            {CARDS.map((card, index) => (
                                ...
                                >
                                    <div className="flex flex-col p-[1.5rem] h-[380px]">
                                        {/* Metrics */}
                                        <div className="mb-[0.8rem]">
                                            <p className="font-['Gilroy-Medium'] text-orange text-[0.8rem] mb-[0.2rem]">{card.metrics}</p>
                                            <p className="font-['Gilroy-Regular'] text-gray-300 text-[0.75rem]">{card.impact}</p>
                                        </div>

                                        {/* Title */}
                                        <h3 className="font-['Denton-Bold'] text-[1.2rem] font-semibold text-white mb-[0.7rem] group-hover:text-orange transition-colors duration-300 leading-tight">
                                            {card.title}
                                        </h3>

                                        {/* Description */}
                                        <p className="font-['Gilroy-Regular'] text-gray-300 text-[0.8rem] leading-relaxed flex-grow mb-[1rem] overflow-hidden">
                                            {card.description}
                                        </p>

                                        {/* Links Section - Fixed at bottom */}
                                        <div className="mt-auto space-y-[0.7rem]">
                                            {/* Website Link */}
                                            <div className="flex items-center gap-[0.5rem]">
                                                ...
                                                <a 
                                                    ...
                                                    className="font-['Gilroy-Medium'] text-white hover:text-orange transition-colors duration-300 text-[0.8rem] truncate"
                                                    onClick={(e) => e.stopPropagation()}
                                                >
                                                    Visit Website
                                                </a>
                                            ...
                                            {/* App Store Links - Horizontal layout for mobile */}
                                                    ...
                                                    <div className="flex items-center gap-[0.3rem]">
                                                        {card.appStore === "coming-soon" ? (
                                                            <div className="flex items-center gap-[0.3rem] opacity-50">
                                                                <svg className="w-[12px] h-[12px] text-gray-500 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
                                                                    <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                                                                </svg>
                                                                <span className="font-['Gilroy-Regular'] text-gray-500 text-[0.7rem]">Soon</span>
                                                            </div>
                                                        ) : (
                                                            <a 
                                                                href={card.appStore} 
                                                                target="_blank" 
                                                                rel="noopener noreferrer"
                                                                className="flex items-center gap-[0.3rem] hover:opacity-80 transition-opacity duration-300"
                                                                onClick={(e) => e.stopPropagation()}
                                                            >
                                                                <svg className="w-[12px] h-[12px] text-blue-400 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
                                                                    <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                                                                </svg>
                                                                <span className="font-['Gilroy-Regular'] text-blue-400 text-[0.7rem]">iOS</span>
                                                            </a>
                                                        )}
                                                    </div>
                                                )}
                                                    ...
                                                    <div className="flex items-center gap-[0.3rem]">
                                                        {card.playStore === "coming-soon" ? (
                                                            ...
                                                            <a 
                                                                ...
                                                                onClick={(e) => e.stopPropagation()}
                                                            >
                                                                <svg className="w-[12px] h-[12px] text-green-400 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
                                                                    <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.6 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.53,12.9 20.18,13.18L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z"/>
                                                                </svg>
                                                                <span className="font-['Gilroy-Regular'] text-green-400 text-[0.7rem]">Android</span>
                                                            </a>
                                                        )}
                                                    </div>
                                                )}
                                            ...
                                            {index === 2 && (
                                                <div className="pt-[0.5rem]">
                                                    <button className="bg-white/10 hover:bg-white/20 transition-colors duration-300 px-[1rem] py-[0.5rem] flex items-center gap-[0.4rem] text-white font-['Gilroy-Medium'] text-[0.75rem] w-full justify-center">
                                                        Read story
                                                        <ArrowRight size={12} />
                                                    </button>
                                                </div>
