        ...
        <FadeInOnScroll>
            <section id='blogs' className='text-white px-[1rem] md:px-[2rem]' style={{ backgroundColor: '#000000' }}>
                <div className='max-w-[1400px] mx-auto pb-[3rem] md:pb-[5rem] lg:pb-[7rem]'>
                    ...
                    <div className='flex flex-col shadow-sm gap-[1rem]'>
                        <div className='grid md:grid-cols-[1.5fr_1fr_1fr] gap-[1rem]'>
                            {
                                BLOG_POSTS.slice(0, 3).map((post, index) => (
                                    <div
                                        key={index}
                                        className='border border-white/20 rounded-[2rem] group backdrop-blur-xl bg-white/8 p-[1.5rem] md:p-[2rem] lg:p-[2.5rem] transition-all duration-300 cursor-pointer min-h-[320px] md:min-h-[350px] lg:min-h-[380px] flex flex-col shadow-2xl relative overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/10 before:via-transparent before:to-transparent transform hover:translate-y-[-0.5rem]'
                                    >
